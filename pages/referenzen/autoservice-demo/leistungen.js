      ...
      <section className="section-container py-12">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          {services.map((service, index) => (
            <article key={service.title} className="rounded-2xl border border-[#cbd3de] bg-[var(--bg-card)] p-6">
              ...
              <Link
                ...
                className="mt-5 inline-flex rounded-md bg-[#111926] px-4 py-2 text-sm font-semibold text-[var(--text-primary)] transition hover:bg-[#1a273b]"
              >
                Termin anfragen
              </Link>
            </article>
