  ...
  return (
    <section id="start" className="section-container pb-12 pt-8 sm:pt-10" aria-labelledby="hero-heading">
      ...
      <div className="mt-4 grid gap-5 lg:grid-cols-[1.25fr_0.75fr] lg:items-stretch">
        <figure className="relative overflow-hidden rounded-[32px] shadow-[0_24px_70px_-40px_rgba(33,22,13,0.8)]">
          <Image
          ...
          <div className="absolute bottom-0 p-8 text-[#f7efe4] sm:p-10">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <Link
                href="#reservierung"
                className="inline-flex rounded-[12px] bg-[#c67b4a] px-6 py-3 text-sm font-semibold text-[var(--text-primary)] transition hover:bg-[#b36b3c]"
              >
                Jetzt reservieren
              </Link>
              <Link
                href="#speisekarte"
                className="inline-flex rounded-[12px] border border-[#f1ddc7] bg-transparent px-6 py-3 text-sm font-semibold text-[#f7efe4] transition hover:bg-[#f7efe4]/15"
              >
                Speisekarte ansehen
              </Link>
            </div>
        ...
        <aside className="grid gap-5 rounded-[32px] bg-[#efe5d7] p-6 sm:p-8">
...
function KitchenStory() {
  return (
    <section className="section-container pb-16" aria-labelledby="kitchen-heading">
      <div className="grid gap-6 rounded-[32px] bg-[#efe3d4] p-7 lg:grid-cols-[1fr_1.1fr] lg:items-center sm:p-10">
        ...
        <div>
          ...
          <div className="mt-6 rounded-[20px] bg-[#f7efe4] shadow-[0_16px_40px_-30px_rgba(15,23,42,0.35)] p-5">
...
function MenuPreview() {
  return (
    <section id="speisekarte" className="section-container pb-16" aria-labelledby="menu-heading">
      ...
      <article className="mb-6 rounded-[20px] bg-[#f7eee2] shadow-[0_16px_40px_-30px_rgba(15,23,42,0.35)] p-6">
      ...
      <div className="grid gap-5 lg:grid-cols-2">
        {menuCategories.map((section) => (
          <article key={section.category} className="rounded-[20px] bg-[#f8f1e7] p-6">
      ...
      <div className="min-h-screen bg-[#f3ece2] text-[#2a2420]">
        ...
        <main>
          ...
          <section className="section-container pb-12" aria-label="Atmosphäre Hinweis">
            <p className="rounded-[20px] bg-[#efe4d6] px-6 py-4 text-[#4f453b]">
          ...
          <section id="reservierung" className="section-container pb-16" aria-labelledby="reservation-heading">
            <div className="grid gap-5 rounded-[32px] bg-[#2e2a27] p-8 text-[#f6eee2] shadow-[0_24px_60px_-36px_rgba(0,0,0,0.8)] lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
              ...
              <div className="flex flex-wrap gap-3 lg:justify-end">
                <Link
                  ...
                  className="inline-flex h-fit rounded-[12px] bg-[#c67b4a] px-7 py-3 text-sm font-semibold text-[var(--text-primary)] transition hover:bg-[#b36b3c]"
                >
                  Jetzt reservieren
                </Link>
                <Link
                  href="tel:+49401234567"
                  className="inline-flex h-fit rounded-[12px] border border-[#d9c7b3] px-7 py-3 text-sm font-semibold text-[#f6eee2] transition hover:bg-[#f6eee2]/10"
                >
          ...
          <section className="section-container pb-14">
            <div className="rounded-[20px] bg-[#efe4d6] p-6 sm:flex sm:items-center sm:justify-between sm:gap-6">
              <p className="text-[#433a31]">Sie möchten eine ähnliche Website für Ihr Restaurant?</p>
              <div className="mt-4 flex flex-wrap gap-3 sm:mt-0">
                <Link href="/kontakt" className="rounded-[12px] bg-[#2e2a27] px-5 py-2.5 text-sm font-semibold text-[#f6eee2]">
                  Eigene Demo anfragen
                </Link>
                <Link href="/#preise" className="rounded-[12px] border border-[#3e3530] px-5 py-2.5 text-sm font-semibold text-[#3e3530]">
                  Preise ansehen
                </Link>
              </div>
            </div>
