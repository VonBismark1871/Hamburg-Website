        ...
        <main>
          ...
          <section className="section-container pb-10 pt-8" id="start" aria-labelledby="hero-heading">
            <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
              <article className="rounded-[32px] bg-[var(--text-primary)dfa] shadow-[0_16px_40px_-30px_rgba(15,23,42,0.35)] p-7 sm:p-10">
          ...
          <section className="section-container pb-16" aria-labelledby="popular-services-heading">
            ...
            <div className="mt-7 grid gap-4 md:grid-cols-3">
              {popularServices.map((service) => (
                <article
                  key={service.title}
                  className="rounded-[20px] bg-[var(--text-primary)dfa] shadow-[0_16px_40px_-30px_rgba(15,23,42,0.35)] p-6 transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_12px_30px_-22px_rgba(53,40,33,0.55)]"
                >
          ...
          <section className="section-container pb-14" aria-label="Vertrauen und Bewertungen">
            <div className="flex flex-col gap-4 rounded-[20px] bg-[var(--text-primary)8f0] shadow-[0_16px_40px_-30px_rgba(15,23,42,0.35)] px-6 py-5 md:flex-row md:items-center md:justify-between">
          ...
          <section className="section-container pb-16" id="leistungen" aria-labelledby="services-heading">
            <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
              <div className="rounded-[32px] bg-[var(--text-primary)9f2] shadow-[0_16px_40px_-30px_rgba(15,23,42,0.35)] p-7 sm:p-9">
              ...
              <div className="rounded-[32px] bg-[var(--text-primary)dfa] shadow-[0_16px_40px_-30px_rgba(15,23,42,0.35)] p-4 sm:p-5">
                <ul className="divide-y divide-[#ebe1d6] overflow-hidden rounded-[20px] bg-[var(--text-primary)af4]">
 shadow-[0_16px_40px_-30px_rgba(15,23,42,0.35)]                  {services.map((service) => (
          ...
          <section className="section-container pb-16" aria-labelledby="lookbook-heading">
            ...
            <div className="mt-7 grid gap-4 sm:grid-cols-2">
              {lookbook.map((item) => (
                <figure key={item.src} className={`overflow-hidden rounded-[20px] ${item.style}`}>
                  <SalonImage
                    src={item.src}
          ...
          <section className="section-container pb-16" aria-labelledby="post-transformation-cta-heading">
            <div className="rounded-[32px] bg-[#332d2a] px-7 py-9 text-[#f7f1e9] sm:px-10 sm:py-11">
          ...
          <section className="section-container pb-16" aria-labelledby="team-heading">
            ...
            <div className="mt-7 grid gap-5 md:grid-cols-3">
              {stylists.map((member) => (
                <article key={member.name} className="overflow-hidden rounded-[20px] bg-[var(--text-primary)df9]">
                  <Image src={member.image} alt={`${member.name}, Friseur mit Schwerpunkt ${member.role}`} width={900} height={980} className="h-72 w-full rounded-[20px] object-cover" />
          ...
          <section className="section-container pb-16" aria-labelledby="reasons-heading">
            <div className="rounded-[32px] bg-[var(--text-primary)af3] shadow-[0_16px_40px_-30px_rgba(15,23,42,0.35)] p-7 sm:p-10">
              ...
              <ul className="mt-6 grid gap-4 sm:grid-cols-3">
                {reasons.map((reason) => (
                  <li key={reason.title} className="rounded-[20px] bg-[var(--bg-card)] shadow-[0_16px_40px_-30px_rgba(15,23,42,0.35)] p-5 shadow-[0_12px_24px_-22px_rgba(52,39,32,0.6)]">
          ...
          <section className="section-container pb-16" aria-labelledby="testimonials-heading">
            ...
            <div className="mt-7 grid gap-4 md:grid-cols-3">
              {testimonials.map((item) => (
                <blockquote key={item.by} className="rounded-[32px] bg-[var(--text-primary)dfa] shadow-[0_16px_40px_-30px_rgba(15,23,42,0.35)] p-6">
          ...
          <section className="section-container pb-14" id="kontakt" aria-labelledby="contact-heading">
            ...
            <div className="mt-7 grid gap-5 lg:grid-cols-2">
              <article className="rounded-[20px] bg-[var(--text-primary)dfa] shadow-[0_16px_40px_-30px_rgba(15,23,42,0.35)] p-7">
              ...
              <aside className="rounded-[20px] bg-[#f9f3eb] shadow-[0_16px_40px_-30px_rgba(15,23,42,0.35)] p-7">
                ...
                <div className="mt-4 overflow-hidden rounded-[20px] border border-[#d6c8ba]">
