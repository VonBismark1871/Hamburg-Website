...
const proofPoints = [
  { label: 'Branchen', value: 'Praxen, Gastro, Service' },
  { label: 'Fokus', value: 'Anfrage statt Deko' },
  { label: 'Stil', value: 'Modern, klar, lokal' }
];
    ...
    <section className="section-container section-spacing" id="portfolio" aria-labelledby="portfolio-heading">
      <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
        <div>
          ...
          >
            Beispiele, die wie echte Unternehmensseiten funktionieren.
          </motion.h2>
          <p className="mt-5 max-w-2xl text-base leading-8 text-slate-600">
            Referenzen sollen nicht nur hübsch aussehen. Sie müssen zeigen, wie Leistungen, Vertrauen und Kontaktpunkte
